...
def red_desconectada(dato):
    # LABORATORIO: reaccion al flanco de perdida de red.
    return ("ALERTA", "Conexion de red perdida")


def red_conectada(dato):
    # LABORATORIO: reaccion al flanco de recuperacion.
    return ("INFO", "Conexion de red recuperada")


def red_sigue_desconectada(dato):
    # LABORATORIO: recordatorio periodico mientras continua desconectada.
    return ("ALERTA", f"La red sigue desconectada ({dato["segundos"]} s)")
...
MANEJADORES = { 
    ...
    "reporte": reporte, 
    # LABORATORIO: nuevos eventos exigidos por el laboratorio.
